...
ALTER TABLE `object_localized_data_2` ADD COLUMN `Image` int(11) NULL;
...
ALTER TABLE `object_localized_query_2_en` ADD COLUMN `Image` int(11) NULL;
...
ALTER TABLE `object_localized_query_2_en_US` ADD COLUMN `Image` int(11) NULL;
