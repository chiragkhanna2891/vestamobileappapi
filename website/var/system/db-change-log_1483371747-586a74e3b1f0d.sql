...
ALTER TABLE `object_query_2` DROP INDEX `p_index_Store`;

/*--NEXT--*/

ALTER TABLE `object_store_2` DROP INDEX `p_index_Store`;
...
SELECT `oo_id`,`oo_classId`,`oo_className`,`o_id`,`o_parentId`,`o_type`,`o_key`,`o_path`,`o_index`,`o_published`,`o_creationDate`,`o_modificationDate`,`o_userOwner`,`o_userModification`,`o_classId`,`o_className`,`en`.`ooo_id` as "ooo_id",`en`.`language` as "language",`en`.`Image` as "Image"
FROM `object_query_2`
    JOIN `objects`
...
SELECT `oo_id`,`oo_classId`,`oo_className`,`o_id`,`o_parentId`,`o_type`,`o_key`,`o_path`,`o_index`,`o_published`,`o_creationDate`,`o_modificationDate`,`o_userOwner`,`o_userModification`,`o_classId`,`o_className`,`en_US`.`ooo_id` as "ooo_id",`en_US`.`language` as "language",`en_US`.`Image` as "Image"
FROM `object_query_2`
    JOIN `objects`
...
CREATE TABLE IF NOT EXISTS `object_classificationstore_groups_2` (
...
CREATE TABLE IF NOT EXISTS `object_classificationstore_data_2` (
            `o_id` BIGINT(20) NOT NULL,
