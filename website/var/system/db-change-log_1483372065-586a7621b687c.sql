...
ALTER TABLE `object_query_1` DROP INDEX `p_index_Store`;

/*--NEXT--*/

ALTER TABLE `object_store_1` DROP INDEX `p_index_Store`;
...
CREATE TABLE IF NOT EXISTS `object_classificationstore_groups_1` (
...
CREATE TABLE IF NOT EXISTS `object_classificationstore_data_1` (
            `o_id` BIGINT(20) NOT NULL,
